...
#### _A console application for determing palindromes_

#### By _**Todd Walraven**_

## Description

_This Application has the user enter a word and check it against another word to determine if the two words are palindromes of each other._
